...
from activity.data_access.activity_data import ActivityData
from activity.entity.artifact_entity import DataIngestionArtifact
from activity.entity.config_entity import DataIngestionConfig
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        try:
            ...
            dataframe = activity_data.export_collection_as_dataframe(
